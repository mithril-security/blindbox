...
+ **Our historical project [BlindAI](docs/past-projects/blindai.md) was successfully audited** by Quarkslab. **No major issues** or vulnerabilities were identified with the core code, which includes our secure remote attestation. BlindAI was meant for the confidential deployment of ONNX models inside Intel SGX enclaves.
